 ...
 * @param {String} options.statics The path to the swagger-editor directory, where index.html is located
 * @param {String} options.specFile The file path which is used to read/write our api specs
 ...
 * @param {boolean} [options.defaults.useBackendForStorage=true] This is true by default, otherwise i would say you are using this extension without reason
